...
\textbf{The generation of the feature vectors for KNN search is still a little bit messy, but can be done with:}
\begin{itemize}
  \item python -m ORIU-project.DFI.preprocessing --dSet LFW --generateOccluded True
  \item python -m ORIU-project.DFI.preprocessing --dSet MNIST --generateOccluded True
  \item python -m ORIU-project.DFI.preprocessing --dSet LFW --generate True
  \item python -m ORIU-project.DFI.preprocessing --dSet MNIST --generate True
  \item python -m ORIU-project.DFI.preprocessing --dSet MNIST\_old --generate True
\end{itemize}
This \textbf{will} take a while.
